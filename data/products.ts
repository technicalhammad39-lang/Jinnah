...
export const CATEGORIES = [
  {
    ...
    count: 24,
    description: "Premium door handles, hinges, lock bodies, mortise systems, door closers, pull handles, and architectural hardware for residential and commercial projects.",
    image: "/1-hardware.jpg",
  },
  {
    id: "security",
    name: "Door Hardware & Security",
    slug: "door-hardware-security",
    count: 18,
    description: "Smart locks, biometric locks, mortise locks, cylinders, door closers, panic bars, and complete security hardware systems.",
    image: "/2-lock.avif",
  },
  {
    id: "kitchen",
    ...
    count: 32,
    description: "Premium kitchen fittings, cabinet accessories, baskets, organizers, soft-close systems, and modern modular kitchen solutions.",
    image: "/3-kitchen.jpg",
  },
  {
    id: "laminates",
    name: "UV & Lamination Sheets",
    slug: "uv-lamination-sheets",
    count: 15,
    description: "High-gloss UV sheets, decorative laminated panels, interior wall sheets, furniture surfaces, and premium finishing materials.",
    image: "/4-sheat.png",
  },
  {
    id: "beading",
    name: "Wood Beading & Profiles",
    slug: "wood-beading-profiles",
    count: 21,
    description: "Decorative wood mouldings, wall beading, finishing trims, edge profiles, and premium interior decorative accessories.",
    image: "/beeding.png",
  },
];
