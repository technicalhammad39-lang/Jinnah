    ...
    <footer className={`relative z-10 border-t border-white/5 bg-[#121110] pt-12 md:pt-20 pb-8 md:pb-10 text-white/90 ${isHome ? "" : "rounded-t-[32px] md:rounded-t-[40px]"}`}>
      ...
      <div className="mx-auto grid max-w-[1920px] grid-cols-1 gap-10 md:gap-12 border-b border-white/5 px-4 sm:px-6 lg:px-8 pb-10 md:pb-16 text-left md:grid-cols-2 lg:grid-cols-12">
        <div className="space-y-6 lg:col-span-4">
          ...
          {/* Unified Single Row for Contact & Social Icons (Without Circles) */}
          <div className="flex items-center gap-4 pt-2 flex-wrap">
            ...
            <a
              ...
              className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer"
            ...
            <a
              ...
              className="inline-flex items-center justify-center text-primary transition-all hover:scale-115 hover:opacity-90 cursor-pointer"
            ...
            {/* Social Media Links (Without Circles) */}
            {settings.facebook && (
              <a href={settings.facebook} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer" title="Facebook">
            ...
            {settings.instagram && (
              <a href={settings.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer" title="Instagram">
            ...
            {settings.youtube && (
              <a href={settings.youtube} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer" title="YouTube">
            ...
            {settings.tiktok && (
              <a href={settings.tiktok} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer" title="TikTok">
            ...
            {settings.twitter && (
              <a href={settings.twitter} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-all hover:scale-115 hover:opacity-90 cursor-pointer" title="X (Twitter)">
