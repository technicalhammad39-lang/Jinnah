...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`relative mx-auto flex w-full max-w-[1920px] min-w-0 items-center justify-between rounded-full border px-4 py-2.5 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] md:px-6 md:py-3 lg:px-5 lg:py-2.5 xl:px-7 xl:py-3 will-change-[transform,background-color,backdrop-filter] ${
            isElevated
